...
def lwf_training(datasets, args):
    ...
    for id_task, task in enumerate(datasets):
        ...
        if id_task == 0:
            ...
            # Save the model
            torch.save(model.state_dict(), f'./models/lwf_{args.dataset}_aftertask_{id_task + 1}.pth')
            ...
            old_model.load_state_dict(torch.load(f'./models/lwf_{args.dataset}_aftertask_{id_task}.pth'))
