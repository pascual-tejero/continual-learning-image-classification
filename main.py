...
if __name__ == '__main__':
    ...
    # BiMeCo parameters
    argparse.add_argument('--memory_size' , type=float, default=2000)
    argparse.add_argument('--bimeco_lambda_short' , type=float, default=1)
    argparse.add_argument('--bimeco_lambda_long' , type=float, default=1)
    argparse.add_argument('--bimeco_lambda_diff' , type=float, default=1)
